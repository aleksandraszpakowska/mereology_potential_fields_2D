...
with open('txt_files/path_coords.txt', 'w') as file:
    for x, y in path_smooth:
        file.write('{} {}\n'.format(x, y))

with open('txt_files/chart_size.txt', 'w') as file:
    for x in size:
        file.write('{}\n'.format(x))

with open('txt_files/goal_coords.txt', 'w') as file:
    for x,y in goal_coordianets:
        file.write('{} {}\n'.format(x, y))

with open('txt_files/start_coords.txt', 'w') as file:
    for x,y in start_coordinates1:
        file.write('{} {}\n'.format(x, y))
